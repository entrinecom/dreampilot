...
DreamPilot.Attributes = (function() {
  ...
  Attributes.requiredAttr = 'required';
  ...
  Attributes.stateAttributes = [self.disabledAttr, self.readOnlyAttr, self.requiredAttr];
    ...
    switch (node.type) {
      ...
      case 'Identifier':
        switch (node.name) {
          ...
          default:
            if (Scope.isMainScope && Scope.isMainScope()) {
